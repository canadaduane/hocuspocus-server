...
class OutgoingMessage {
    ...
    createSyncMessage() {
        ...
        writeVarUint$1(this.encoder, MessageType.Sync);
        return this;
    }
    createSyncReplyMessage() {
        this.type = MessageType.SyncReply;
        writeVarUint$1(this.encoder, MessageType.SyncReply);
        return this;
    }
    createAwarenessUpdateMessage(awareness, changedClients) {
        ...
        writeVarUint$1(this.encoder, MessageType.Awareness);
    ...
    writeQueryAwareness() {
        ...
        this.category = 'Update';
        writeVarUint$1(this.encoder, MessageType.QueryAwareness);
        return this;
    }
    writeAuthenticated() {
        this.type = MessageType.Auth;
        this.category = 'Authenticated';
        writeVarUint$1(this.encoder, MessageType.Auth);
    ...
    writeStateless(payload) {
        ...
        writeVarUint$1(this.encoder, MessageType.Stateless);
        writeVarString$1(this.encoder, payload);
        return this;
    }
    writeBroadcastStateless(payload) {
        this.category = 'Stateless';
        writeVarUint$1(this.encoder, MessageType.BroadcastStateless);
        writeVarString$1(this.encoder, payload);
        return this;
    }
    toUint8Array() {
...
class Hocuspocus {
     ...
     */
    async createDocument(documentName, request, socketId, connectionConfig, context) {
