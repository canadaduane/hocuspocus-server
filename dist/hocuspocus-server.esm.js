...
const listenerStats = new Map();
function listenerIncr(name) {
    var _a;
    listenerStats.set(name, (_a = listenerStats.get(name)) !== null && _a !== void 0 ? _a : 0 + 1);
}
function listenerDecr(name) {
    var _a;
    listenerStats.set(name, (_a = listenerStats.get(name)) !== null && _a !== void 0 ? _a : 0 - 1);
}
...
const useDebounce = () => {
    ...
    const debounce = (id, func, debounce, maxDebounce) => {
...
class Hocuspocus {
    ...
    get address() {
        var _a, _b;
        return (((_b = (_a = this.server) === null || _a === void 0 ? void 0 : _a.httpServer) === null || _b === void 0 ? void 0 : _b.address()) || {
            port: this.configuration.port,
    ...
    async destroy() {
        ...
        try {
            ...
            (_f = (_e = this.server) === null || _e === void 0 ? void 0 : _e.webSocketServer) === null || _f === void 0 ? void 0 : _f.clients.forEach(client => {
                client.terminate();
            });
        }
        catch (error) {
    ...
    handleConnection(incoming, request, defaultContext = {}) {
        ...
        clientConnection.onClose((document, hookPayload) => {
            ...
            if (!document.isLoading) {
                ...
                }, this.configuration.unloadImmediately ? 0 : this.configuration.debounce, this.configuration.maxDebounce);
            }
            else {
    ...
    handleDocumentUpdate(document, connection, update, request) {
        ...
        this.debounce(`onStoreDocument-${document.name}`, () => {
            this.storeDocumentHooks(document, hookPayload);
        }, this.configuration.debounce, this.configuration.maxDebounce);
    }
    /**
...
export { Connection, Debugger, Document, Hocuspocus, IncomingMessage, MessageReceiver, MessageType, OutgoingMessage, Server, defaultConfiguration, listenerStats, useDebounce };
